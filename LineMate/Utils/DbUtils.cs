...
namespace LineMate.Utils
{
    ...
    public static class DbUtils
    {
        ...
        /// <param name="column">The name of the column from the result set refereed to tbe the reader.</param>
        ...
        /// <summary>
        /// Add parameter to the given SqlCommand object and grace fully handle null values.
        /// </summary>
